...
public abstract class Waveform {
    ...
    protected float scaleFactor; // The scaling factor (how much to zoom) ** May delete **
    protected float adjustedAmp; // May delete
    ...
    //public abstract void playWave(int durationMs);
